...
parser.add_argument('--filter_sizes', type=str, default='2,3,4,5', help='label')
parser.add_argument('--num_filters', type=int, default='8', help='length')
...
def save_weights():
    ...
    with tf.Session() as sess:
        ...
        np.savetxt(os.path.join(file_path, "data_vec_cnn", "user_vec.txt"), user_vec, fmt="%0.4f")
        np.savetxt(os.path.join(file_path, "data_vec_cnn", "movie_vec.txt"), movie_vec, fmt="%0.4f")
